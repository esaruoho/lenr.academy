 ...
 *
 * This config is used when testing against a production build served via `npm run preview`.
 * It enables testing of service worker functionality, PWA features, and other production-only behavior.
 *
