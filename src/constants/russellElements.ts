    ...
    elements: [
      {
        ...
        side: 'inertGas',
        status: 'hypothetical',
        note: 'Hypothetical first inert gas — the beginning of matter',
      },
    ],
  },
    ...
    elements: [
      {
        ...
        side: 'inertGas',
        status: 'hypothetical',
        note: 'Hypothetical second inert gas',
      },
    ],
  },
    ...
    elements: [
      {
        ...
        side: 'inertGas',
        status: 'hypothetical',
        note: 'Hypothetical third inert gas',
      },
    ],
  },
  ...
  // Octave 4: HYDRON — first octave with known elements
  {
    ...
    elements: [
      ...
      },
      {
        ...
        side: 'generation',
        status: 'predicted',
        note: 'Russell predicted "Ethlogen" — identified as Deuterium (1931)',
      },
      {
        russellName: 'Bebegen',
        modernSymbol: 'T',
        ...
        side: 'generation',
        status: 'predicted',
        note: 'Russell predicted "Bebegen" — identified as Tritium (1934)',
      },
      {
        ...
        side: 'generation',
        status: 'hypothetical',
        note: 'Hypothetical element in Russell\'s system',
      },
      {
        ...
        side: 'inertGas',
        status: 'known',
        note: 'Russell placed Helium as the inert gas of octave 4',
      },
      {
        russellName: 'Luminon',
        position: 1,
  ...
  // Octave 5: HELIUM octave (Li through F, with Carbon at the amplitude)
  {
    ...
    elements: [
      ...
      },
      {
        ...
        side: 'generation',
        status: 'known',
        note: 'Carbon — the amplitude of the wave; maximum compression point',
      },
      {
        russellName: 'Neon',
        modernSymbol: 'Ne',
  ...
  // Octave 9: XENON octave (Cs through Bi, plus predicted Np and Pu)
  {
    ...
    elements: [
      ...
      },
      {
        ...
        side: 'radiation',
        status: 'predicted',
        note: 'Russell predicted element 93 in 1926 — discovered as Neptunium in 1940',
      },
      {
        ...
        side: 'generation',
        status: 'predicted',
        note: 'Russell predicted element 94 in 1926 — discovered as Plutonium in 1941',
      },
    ],
  },
    ...
    elements: [
      {
        ...
        side: 'generation',
        status: 'hypothetical',
        note: 'Hypothetical trans-uranic element in Russell\'s system',
      },
      {
        russellName: 'Whytton',
        position: -3,
        side: 'generation',
        status: 'hypothetical',
        note: 'Hypothetical trans-uranic element',
      },
      {
      ...
      },
      {
        ...
        side: 'inertGas',
        status: 'hypothetical',
        note: 'Hypothetical final inert gas — the end of matter',
      },
      {
